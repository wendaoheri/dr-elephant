...
alter table yarn_app_result add column memory_seconds    BIGINT        UNSIGNED DEFAULT 0    COMMENT 'The resources used by the job in MB Seconds from YARN';
alter table yarn_app_result add column vcore_seconds    BIGINT        UNSIGNED DEFAULT 0    COMMENT 'The vcores used by the job in Seconds from YARN';
# --- !Downs
...
alter table yarn_app_result drop memory_seconds;
alter table yarn_app_result drop vcore_seconds;
